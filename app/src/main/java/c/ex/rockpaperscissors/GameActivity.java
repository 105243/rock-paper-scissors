    ...
    public void makeChoice(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.paperButton:
                yourChoice.setImageDrawable(getDrawable(R.drawable.paper2));
                yourChoiceString = "paper";
                break;
            case R.id.scissorsButton:
                yourChoice.setImageDrawable(getDrawable(R.drawable.scissors2));
    ...
    public void enemyChoice() {
        ...
        switch (enemyChoiceString){
            ...
            case "rock": enemyChoice.setImageDrawable(getDrawable(R.drawable.rock));
                break;
            case "paper": enemyChoice.setImageDrawable(getDrawable(R.drawable.paper2));
                break;
            case "scissors": enemyChoice.setImageDrawable(getDrawable(R.drawable.scissors2));
                break;
        }
    }
